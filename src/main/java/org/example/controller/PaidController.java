...
public class PaidController {
    ...
    public ModelAndView home() {
        return new ModelAndView("userPaid/home");
    }

    @GetMapping("/tarif")
    public ModelAndView tarif() {return new ModelAndView("userPaid/tarif");}

    @GetMapping("/instruct")
    public ModelAndView instruct() {return new ModelAndView("userPaid/instruct");}

    @GetMapping("/changPass")
    public ModelAndView loadChangePassword() {
        return new ModelAndView("userPaid/changePassword");
    }
    ...
    public ModelAndView changePassword(Principal p, @RequestParam("oldPass") String oldPass,
        ...
        return new ModelAndView("redirect:/userPaid/changPass");
    }
    ...
    public Object uploadFile(@RequestParam("file") MultipartFile[] file, HttpSession session)
        ...
        try {
            if (ExcelHelper.hasExcelFormat(file[0]) | ExcelHelper.hasExcelFormat(file[1])) {
                ...
                return new ModelAndView("redirect:/userPaid/home");
            }
