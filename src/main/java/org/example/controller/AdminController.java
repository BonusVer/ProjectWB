...
public class AdminController {
    ...
    @GetMapping("/tarif")
    public ModelAndView tarif() {return new ModelAndView("admin/tarif");}

    @GetMapping("/instruct")
    public ModelAndView instruct() {return new ModelAndView("admin/instruct");}
    ...
    public ModelAndView changePassword(Principal p, @RequestParam("oldPass") String oldPass,
        ...
        return new ModelAndView("redirect:/admin/changPass");
    }
